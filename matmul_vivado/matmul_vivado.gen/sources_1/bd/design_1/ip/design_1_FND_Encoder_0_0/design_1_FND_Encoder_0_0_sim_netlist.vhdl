...
--               d:/Workspace/2024-2/soc/final_project/matmul_vivado/matmul_vivado.gen/sources_1/bd/design_1/ip/design_1_FND_Encoder_0_0/design_1_FND_Encoder_0_0_sim_netlist.vhdl
...
entity design_1_FND_Encoder_0_0_ovf2seg is
  ...
  attribute ORIG_REF_NAME of design_1_FND_Encoder_0_0_ovf2seg : entity is "ovf2seg";
end design_1_FND_Encoder_0_0_ovf2seg;

architecture STRUCTURE of design_1_FND_Encoder_0_0_ovf2seg is
  signal \seg1_data_reg[7]_i_1_n_0\ : STD_LOGIC;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \seg1_data_reg[7]\ : label is "LDC";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of \seg1_data_reg[7]\ : label is "VCC:GE";
begin
\seg1_data_reg[7]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\seg1_data_reg[7]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
entity design_1_FND_Encoder_0_0_FND_Encoder is
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_FND_Encoder_0_0_FND_Encoder : entity is "FND_Encoder";
...
\com_out[1]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of design_1_FND_Encoder_0_0 is
  ...
  signal \^com_out\ : STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
  com_out(3) <= \<const1>\;
  com_out(2) <= \<const1>\;
  com_out(1 downto 0) <= \^com_out\(1 downto 0);
  seg_out(7) <= \^seg_out\(2);
  seg_out(6) <= \^seg_out\(6);
  seg_out(5) <= \^seg_out\(6);
  seg_out(4) <= \^seg_out\(6);
